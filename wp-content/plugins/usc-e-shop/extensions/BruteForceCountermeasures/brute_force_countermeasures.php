		...
		<form action="" method="post" name="option_form" id="brute_force_form">
			<div class="postbox">
				<div class="postbox-header">
					<h2><span><?php _e('Brute-force attack countermeasures', 'usces'); ?></span><?php echo $status; ?></h2>
					<div class="handle-actions"><button type="button" class="handlediv" id="brute_force"><span class="screen-reader-text">パネルを切り替え: <?php _e('Brute-force attack countermeasures', 'usces'); ?></span><span class="toggle-indicator"></span></button></div>
				</div>
				<div class="inside">
