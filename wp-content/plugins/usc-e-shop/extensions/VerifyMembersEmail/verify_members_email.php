...
?>
	...
	<div class="postbox">
		<div class="postbox-header">
			...
			<div class="handle-actions"><button type="button" class="handlediv" id="verifyemail"><span class="screen-reader-text">ƒpƒlƒ‹‚ğØ‚è‘Ö‚¦: <?php _e('Verify New Member Email','usces'); ?></span><span class="toggle-indicator"></span></button></div>
		</div>
		<div class="inside">
