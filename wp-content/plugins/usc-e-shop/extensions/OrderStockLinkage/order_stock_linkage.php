...
?>
	...
	<div class="postbox">
		<div class="postbox-header">
			<h2><span><?php _e('Stock Linkage OrderData','usces'); ?></span><?php echo $status; ?></h2>
			<div class="handle-actions"><button type="button" class="handlediv" id="stocklink"><span class="screen-reader-text">パネルを切り替え: <?php _e('Stock Linkage OrderData','usces'); ?></span><span class="toggle-indicator"></span></button></div>
		</div>
		<div class="inside">
