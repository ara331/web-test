...
?>
	...
	<div class="postbox">
		<div class="postbox-header">
			...
			<div class="handle-actions"><button type="button" class="handlediv" id="ganbare"><span class="screen-reader-text">パネルを切り替え: <?php _e('Ganbare Tencho','usces'); ?></span><span class="toggle-indicator"></span></button></div>
		</div>
		<div class="inside">
