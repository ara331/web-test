		...
		<form action="" method="post" name="option_form" id="google_recaptcha_form">
			<div class="postbox">
				<div class="postbox-header">
					<h2><span><?php _e( 'Google reCAPTCHA v3','usces' ); ?></span><?php echo $status; ?></h2>
					<div class="handle-actions"><button type="button" class="handlediv" id="google_recaptcha"><span class="screen-reader-text">パネルを切り替え: <?php _e( 'Google reCAPTCHA v3','usces' ); ?></span><span class="toggle-indicator"></span></button></div>
				</div>
				<div class="inside">
